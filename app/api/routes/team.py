...
from app.api.dependencies import (
    CurrentTeamFromKeys, CurrentUser, SessionDep, ValidateTeamOnUpdate, ValidateTeamOnRead, 
    create_member_for_team, validate_team_name_on_create
)
...
async def read_teams(
    session: SessionDep, current_user: CurrentUser, team_filter: TeamFilter = FilterDepends(TeamFilter)
) -> Any:
    """
    Retrieve teams
    """
...
async def read_team(team: ValidateTeamOnRead) -> Any:
    """
    Get team by ID.
    """
    return team
...
async def create_team(
    *,
    ...
    team_in: TeamCreate,
    _: bool = Depends(validate_team_name_on_create),
) -> Team:
    """
...
@router.delete("/{id}")
async def delete_team(session: SessionDep, team: ValidateTeamOnRead) -> Any:
    """
    Delete a team.
    """
