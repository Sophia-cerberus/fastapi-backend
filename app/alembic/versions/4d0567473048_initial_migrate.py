...
Revision ID: 4d0567473048
Revises: 
Create Date: 2025-03-29 06:11:15.563733
...
def upgrade():
    ...
    sa.Column('owner_of', sa.Uuid(), nullable=True),
    ...
    op.create_index(op.f('ix_subgraph_id'), 'subgraph', ['id'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_subgraph_id'), table_name='subgraph')
